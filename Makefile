...
SOURCES=src/extension.cpp src/core.cpp src/task_runner.cpp src/net/init.cpp src/net/udp_socket.cpp src/net/tcp_socket.cpp src/net/tcp_server.cpp src/net_mill/http/init.cpp src/net_mill/http/request.cpp src/net_mill/http/response.cpp
